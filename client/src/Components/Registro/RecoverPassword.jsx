      ...
      <div className={style2.options}>
        <form onSubmit={(e)=>login(e)}>
          <div className={style.inputcontainer}>
            ...
            <input className= {style3.input} style={{width:"400px"}} type="text" name="username" onChange={handleOnChange} required />
          </div>
          <div className={style.inputcontainer}>
          ...
          <div className={style.buttoncontainer}>
            <button className={style2.button} data='Recuperar Contraseña' type="submit" value='' />
          </div>
        </form>
      </div>
    </div>
